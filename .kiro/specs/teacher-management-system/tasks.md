...
- [ ] 5. Implement Infrastructure layer
  - [ ] 5.1 Implement `MongoDbSettings` and `MongoDbContext`
...
- [ ] 7. Implement Application layer — Teacher commands
  ...
  - [ ] 7.7 Implement `SetTeacherAvailabilityCommand`, validator, and handler
...
- [ ] 9. Implement Application layer — all queries
  ...
  - [ ] 9.7 Implement `GetSubjectsByTeacherQuery` and handler
